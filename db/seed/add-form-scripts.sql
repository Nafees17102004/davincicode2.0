...
CREATE TABLE `add_form_table` (
  `ADD_FORM_ID` INT NOT NULL AUTO_INCREMENT,
  `TAB_ID` INT NOT NULL,
  ...
  `STORING_SP` VARCHAR(255) DEFAULT NULL,
  ...
  CONSTRAINT `add_form_table_ibfk_1` FOREIGN KEY (`TAB_ID`) REFERENCES `tab_table` (`TAB_ID`) ON DELETE CASCADE,
  CONSTRAINT `add_form_table_ibfk_2` FOREIGN KEY (`FIELD_SOURCE_LOV_DET_ID`) REFERENCES `list_of_values_details` (`LOV_DET_ID`) ON DELETE SET NULL,
  CONSTRAINT `add_form_table_ibfk_3` FOREIGN KEY (`FIELD_SIZE_LOV_DET_ID`) REFERENCES `list_of_values_details` (`LOV_DET_ID`) ON DELETE SET NULL,
  CONSTRAINT `add_form_table_ibfk_4` FOREIGN KEY (`FIELD_ICON_LOV_DET_ID`) REFERENCES `list_of_values_details` (`LOV_DET_ID`) ON DELETE SET NULL,
  CONSTRAINT `add_form_table_ibfk_5` FOREIGN KEY (`FIELD_ORDER_LOV_DET_ID`) REFERENCES `list_of_values_details` (`LOV_DET_ID`) ON DELETE SET NULL,
